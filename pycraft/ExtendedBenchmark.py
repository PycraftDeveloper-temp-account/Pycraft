if __name__ != "__main__":
    print("Started <Pycraft_ExtendedBenchmark>")
            ...
            try:
                ...
                while iteration < (500*SetFPSlength):
                    ...
                    while not iteration == Maxiteration:
                        ...
                        self.mod_drawing_utils__.DrawRose.CreateRose(
                            self,
                            1,
                            1,
                            False)
                        ...
                        while self.iteration < 500*self.SetFPSlength:
                            ...
                            try:
                                ...
                                if str(Message) != "'NoneType' object has no attribute 'flip'":
                                    SharedData.error_message = "".join(("ExtendedBenchmark > ",
                                                                f"Create3Dbenchmark > {str(Message)}"))

                                    SharedData.error_message_detailed = "".join(
                                ...
                                self.SharedData.mod_display_utils__.displayUtils.set_display(self.SharedData)
