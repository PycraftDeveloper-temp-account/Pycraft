    ...
    class ThreadingUtils:
        ...
        def StartVariableChecking(self):
            try:
                ...
                print("'thread_start_long_thread' has stopped")
        ...
        def StartCPUlogging(self):
            try:
                ...
                print("'thread_get_CPU_metrics' has stopped")
                self.error_message = "".join(("ThreadingUtils > ThreadingUtils ",
        ...
        def AdaptiveMode(self):
            try:
                while True:
                    if self.settings_preference == "Adaptive":
                ...
                print("'thread_adaptive_mode' has stopped")
