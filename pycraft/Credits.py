    ...
    class GenerateCredits:
        ...
        def Credits(self):
            try:
                ...
                CreditsFont = Infotitle_font.render(
                    "Credits",
                    self.aa,
                ...
                while True:
                    ...
                    if timer >= 1:
                        self.display.blit(
                            title_font,
                            ((self.real_window_width-TitleWidth)/2, 0+IntroYDisplacement))
                        ...
                        if IntroYDisplacement <= 0:
                            ...
                            self.display.blit(
                                CreditsFont,
                                (((self.real_window_width-TitleWidth)/2)+65, 50+IntroYDisplacement))
                    ...
                    if self.go_to is None:
                        ...
                        self.mod_display_utils__.displayAnimations.FadeOut(
                            self)
