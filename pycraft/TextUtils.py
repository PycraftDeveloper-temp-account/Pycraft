    ...
    class GenerateText:
        ...
        def LoadQuickText(self):
            try:
                ...
                self.error_message = "TextUtils > GenerateText > LoadQuickText: "+str(Message)
            ...
            try:
                ...
                for line in words:
                    for word in line:
                        ...
                        if x + word_width >= self.real_window_width:
                ...
                self.error_message = "TextUtils > TextWrap > blit_text: "+str(Message)
