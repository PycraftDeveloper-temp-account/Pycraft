    ...
    class GenerateBenchmarkMenu:
        ...
        def Benchmark(self):
            try:
                ...
                BenchmarkFont = Infotitle_font.render(
                    "Benchmark",
                    self.aa,
                ...
                while True:
                    ...
                    if stage == 0:
                        ...
                        self.display.blit(
                            BenchmarkFont,
                            (((self.real_window_width-TitleWidth)/2)+65, 50))
                    ...
                    if stage == 4:
                        ...
                        self.recommended_FPS = GlobalMax/2
                    ...
                    if stage == 5:
                        ...
                        self.display.blit(
                            FPSinfoTEXT,
                            ((self.real_window_width-FPSinfoTEXTWidth)-3, 100))

                        self.display.blit(
                            FILEinfoTEXT,
                            ((self.real_window_width-FILEinfoTEXTWidth)-3, 430))
                        ...
                        self.display.blit(
                            HARDWAREinfoTEXT,
                            ((self.real_window_width-HARDWAREinfoTEXTwidth)-3, 480))
                    ...
                    if not self.error_message is None:
                        self.error_message = "".join(("Benchmark > GenerateBenchmarkMenu",
                                                     f"> Benchmark: {str(self.error_message)}"))
                        return
                    self.run_timer += self.mod_time__.perf_counter()-StartTime
            except Exception as Message:
                self.error_message = "Benchmark > GenerateBenchmarkMenu > Benchmark: "+str(Message)
