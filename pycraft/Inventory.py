                ...
                while True:
                    ...
                    if self.use_mouse_input is False:
                        if self.joystick_hat_pressed:
                            ...
                            if self.joystick_mouse[1] == "Down" and MenuSelector <= 7:
                                MenuSelector += 1
                                if MenuSelector == 8:
                                    MenuSelector = 0
                    ...
                    if ((self.mouse_y >= 552*yScaleFact and
                                self.mouse_y <= 597*yScaleFact and self.mouse_x >= 1095) or
                            (MenuSelector == 7 and
                                self.use_mouse_input is False)):
                    ...
                    if hover1:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(WeaponsTextWidth+SelectorWidth)-2,
                             200*yScaleFact))
                    ...
                    if hover2:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(RangedWeaponsTextWidth+SelectorWidth)-2,
                             250*yScaleFact))
                    ...
                    if hover3:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(ShieldsTextWidth+SelectorWidth)-2,
                             300*yScaleFact))
                    ...
                    if hover4:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(FoodTextWidth+SelectorWidth)-2,
                             400*yScaleFact))
                    ...
                    if hover5:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(ArmourTextWidth+SelectorWidth)-2,
                             350*yScaleFact))
                    ...
                    if hover6:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(SpecialItemsTextWidth+SelectorWidth)-2,
                             500*yScaleFact))
                    ...
                    if hover7:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(ItemsTextWidth+SelectorWidth)-2,
                             450*yScaleFact))
                    ...
                    if hover8:
                        AlphaSurface.blit(
                            Selector,
                            (self.real_window_width-(OptionsTextWidth+SelectorWidth)-2,
                             550*yScaleFact))
