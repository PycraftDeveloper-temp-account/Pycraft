if __name__ != "__main__":
    ...
    class GameEngine(shared_data.mod_base__.CameraWindow):
        ...
        shared_data.mod_base__.CameraWindow.vsync = False
            ...
            try:
                ...
                while self.Running:
                    ...
                    if self.shared_data.devmode == 10:
                        self.shared_data.mod_caption_utils__.GenerateCaptions.GetOpenGLCaption(
                            shared_data,
                            self)
                    ...
                    if self.Thundertimer > self.Thundertimer_Target:
                        ...
                        self.Flashtimer = 0
                        self.Lightningtimer = 0
                        if self.shared_data.show_lightning:
                            self.color.value = (1.0, 1.0, 1.0)
                    ...
                    if shared_data.FPS_overclock is False:
                        try:
                ...
                self.shared_data.mod_main__.Initialize.MenuSelector(self)
            except Exception as Message:
