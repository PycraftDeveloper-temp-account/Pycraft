    ...
    class MapTexture:
        ...
        def LoadMapTexture(self):
            try:
                ...
                #self.mod_OpenGL_GL_.glTexParameteri(self.mod_OpenGL_GL_.GL_TEXTURE_2D, self.mod_OpenGL_GL_.GL_TEXTURE_MAX_LEVEL, 0)
                #self.mod_OpenGL_GL_.glTexParameteri(self.mod_OpenGL_GL_.GL_TEXTURE_2D, self.mod_OpenGL_GL_.GL_TEXTURE_BASE_LEVEL, 0)
                #color = [0.0, 1.0, 0.0]
