if __name__ == "__main__":
    ...
    class Startup:
        def __init__(Class_Startup_variables):
            try:
                ...
                import SetVertexData
                Class_Startup_variables.mod_SetVertexData__ = SetVertexData
    ...
    print("You need to run this module yourself, not through another program")
    import tkinter as tk
    from tkinter import messagebox
    root = tk.Tk()
    root.withdraw()
    messagebox.showerror("Startup Fail", "You need to run this yourself, not through another program")
    quit()